    ...
    >
      ...
      <nav class="relative flex flex-col w-64 h-full bg-white shadow-xl">
          ...
          <ul class="space-y-2">
            <li>
              ...
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  :class="mobileNavIconClass('/dashboard')"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
            ...
            <li>
              <router-link
                to="/trainees"
                class="flex items-center p-3 rounded-md hover:bg-light-blue text-lg min-h-[44px]"
                @click="mobileMenuOpen = false"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-6 w-6 mr-3 text-primary-blue"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
        ...
        <div class="p-4 border-t">
          <button class="flex items-center p-3 w-full text-left rounded-md hover:bg-light-blue text-lg min-h-[44px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6 mr-3 text-error"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
...
const navLinkClass = (path) => {
  return isActiveRoute(path) 
    ? 'flex items-center p-2 rounded-md bg-primary-blue text-white hover:bg-dark-blue transition-colors'
    : 'flex items-center p-2 rounded-md hover:bg-light-blue transition-colors';
};

const navIconClass = (path) => {
  return isActiveRoute(path) 
    ? 'h-5 w-5 mr-3 text-white'
    : 'h-5 w-5 mr-3 text-primary-blue';
};

const mobileNavLinkClass = (path) => {
  return isActiveRoute(path)
    ? 'flex items-center p-3 rounded-md bg-primary-blue text-white hover:bg-dark-blue text-lg min-h-[44px]'
    : 'flex items-center p-3 rounded-md hover:bg-light-blue text-lg min-h-[44px]';
};

const mobileNavIconClass = (path) => {
  return isActiveRoute(path)
    ? 'h-6 w-6 mr-3 text-white'
    : 'h-6 w-6 mr-3 text-primary-blue';
};
</script>