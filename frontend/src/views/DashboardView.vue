<template>
  <div>
    <div class="mb-6">
      <h1 class="text-display font-bold text-dark-gray">
        Welcome, {{ authStore.user?.name || 'Trainer' }}
      </h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2">
        <div class="card mb-6">
          ...
          <div class="space-y-4">
            <!-- Session Item -->
            <div class="flex items-center p-3 bg-light-gray rounded-md">
              <div class="w-12 h-12 rounded-full bg-primary-blue text-white flex items-center justify-center text-lg font-bold mr-4">
                8:00
              </div>
              <div class="flex-1">
                <p class="font-medium">
 ...
 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
        ...
        <div class="card">
          ...
          <div class="space-y-4">
            <div class="flex">
              <div class="w-10 h-10 rounded-full bg-primary-blue/20 flex items-center justify-center mr-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div>
                <p class="font-medium">
                  Michael Chen completed HIIT Workout
                </p>
                <p class="text-sm text-medium-gray">
                  Today at 11:45 AM
                </p>
            ...
            <div class="flex">
              ...
              <div>
                <p class="font-medium">
                  Emily Rodriguez reached her weight goal
                </p>
                <p class="text-sm text-medium-gray">
            ...
            <div class="flex">
              ...
              <div>
                <p class="font-medium">
                  Sarah Johnson viewed her workout plan
                </p>
                <p class="text-sm text-medium-gray">
            ...
            <div class="flex">
              ...
              <div>
                <p class="font-medium">
                  Alex Thompson reported knee discomfort
                </p>
                <p class="text-sm text-medium-gray">
                  2 days ago
                </p>
        ...
        <div class="card">
          ...
          <div class="space-y-3">
            <button
              ...
              @click="$router.push('/trainees/new')"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 mr-2"
          ...
          <div class="space-y-4">
            <div>
              <div class="flex justify-between mb-1">
                <span class="text-sm font-medium">Session Completion Rate</span>
            ...
            <div>
              <div class="flex justify-between mb-1">
                <span class="text-sm font-medium">Trainee Satisfaction</span>
            ...
            <div>
              <div class="flex justify-between mb-1">
                <span class="text-sm font-medium">Goal Achievement</span>
...
const sessionsThisWeek = computed(() => {
  // TODO: Calculate actual sessions this week from API
...
onMounted(async () => {
  // Load trainees data if not already loaded
